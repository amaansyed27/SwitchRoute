...
export default function LandingPage() {
  return <main className="min-h-screen overflow-hidden bg-[var(--background)] text-[var(--foreground)]">
    ...
    <header className="sticky top-0 z-40 border-b border-[var(--border)] bg-[color-mix(in_srgb,var(--background)_88%,transparent)] backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-sm" aria-label="Primary navigation">
          ...
          <Link className="sr-motion-control hidden rounded-lg px-3 py-2 text-[var(--muted-foreground)] hover:bg-[var(--surface-hover)] hover:text-[var(--foreground)] sm:block" href="/docs/getting-started">Docs</Link>
    ...
    <section className="relative min-h-[calc(100vh-64px)] overflow-hidden border-b border-[var(--border)]">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-64px)] max-w-[1280px] gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[minmax(0,1fr)_minmax(470px,.92fr)] lg:items-center lg:px-8 lg:py-24">
    ...
    <section className="relative mx-auto max-w-[1280px] px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
    ...
    <section className="border-y border-[var(--border)] bg-[#0d1014] text-[#e8ebef]">
