...
export function DashboardClient() {
  ...
  const load = useCallback(async () => { setError(null); try { setData(await manageFetch<Summary>("dashboard")); } catch (err) { setError(err instanceof Error ? err.message : "Overview could not be loaded."); } }, []);
